...
public class CreateOrganizationRequestCommandHandler(IUnitOfWork unitOfWork, IOrganizationRepository organizationRepository) : IRequestHandler<CreateOrganizationRequestCommand, OrganizationRegisterRequestResponseDto>
{
    public async Task<OrganizationRegisterRequestResponseDto> Handle(CreateOrganizationRequestCommand request, CancellationToken cancellationToken)
    {
